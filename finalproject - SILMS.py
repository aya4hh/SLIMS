...
window = tk.Tk()
window.title("STUDENT INDEPENDENT LIVING MANAGEMENT SYSTEM")
window.geometry("1920x1080")
window.configure(bg=BG_MAIN)
window.resizable(True, True)

page_container = tk.Frame(window, bg=BG_MAIN)
...
# This dictionary stores all our page frames by name
# Example: all_pages["main"] = the main menu frame
all_pages = {}
...
def build_main_menu(parent):
   ...
   #mainframe
    ...
    make_button(footer_area, "exit", window.destroy, "#dfe6e9").pack()
